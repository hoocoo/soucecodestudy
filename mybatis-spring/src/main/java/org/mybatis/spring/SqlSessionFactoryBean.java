...
public class SqlSessionFactoryBean
  ...
  private Resource configLocation;//mybatis 核心路径配置

  private Configuration configuration;//mybatis上下文，重对象

  private Resource[] mapperLocations;//mapper  xml文件路径
  ...
  private SqlSessionFactory sqlSessionFactory;//使用默认defaultSqlSessionFactory对象
  ...
  private Interceptor[] plugins;//插件，责任链模式

  private TypeHandler<?>[] typeHandlers;//类型处理器

  private String typeHandlersPackage;

  private Class<?>[] typeAliases;//别名
